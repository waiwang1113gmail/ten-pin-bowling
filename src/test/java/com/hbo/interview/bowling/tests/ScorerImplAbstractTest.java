...
import com.hbo.interview.bowling.TenPinBowlingScorer; 
...
public abstract class ScorerImplAbstractTest {
    ...
    protected final Scorer intervieweeImpl = new TenPinBowlingScorer();/* TODO - add your implementation here; i.e., new ScorerRefImpl(); */
